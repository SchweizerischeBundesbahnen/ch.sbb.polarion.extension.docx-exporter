...
what it would fetch is not what the stylesheet names. An at-rule cannot be embedded either, so pandoc-service would have to load it itself, past every check above. Reference
