...
const GENERIC_JS_MODULES_IMPORT_PATH_PREFIX = '/polarion/docx-exporter/ui/generic/js/modules';
const GENERIC_UNPACKED_JS_MODULES_ROOT_FOLDER = '../../../target/generic-jar-content/js/modules';
const SRC_JS_MODULES_IMPORT_PATH_PREFIX = '../../main/resources/webapp/docx-exporter/js/modules';
