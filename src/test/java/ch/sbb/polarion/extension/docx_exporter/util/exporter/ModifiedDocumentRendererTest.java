...
class ModifiedDocumentRendererTest {
    ...
    // RichTextRenderTarget is a sealed abstract enum in Polarion 2606 and cannot be mocked; use a real literal
    ...
    void setUp() {
        ...
        mockedHtmlFragmentParserConstruction = mockConstruction(RichTextRenderingContext.class, withSettings().defaultAnswer(RETURNS_DEEP_STUBS),
                (mock, context) -> when(mock.documentLazyLoad()).thenAnswer((Answer<Boolean>) invocationOnMock -> documentLazyLoad));
    }
