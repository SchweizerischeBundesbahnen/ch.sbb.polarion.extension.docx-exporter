...
class DocxExporterPolarionServiceTest {
    ...
    void userAuthorizedForExportWhenUserHasAllowedGlobalRole() {
        ...
        DocxExporterPolarionService svc = authorizationService(securityService);
    ...
    private DocxExporterPolarionService authorizationService(ISecurityService securityService) {
        return spy(new DocxExporterPolarionService(
                trackerService,
                mock(IProjectService.class),
                securityService,
                mock(IPlatformService.class),
