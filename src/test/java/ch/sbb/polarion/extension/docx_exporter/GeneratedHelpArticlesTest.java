 ...
 *       {@code /polarion/docx-exporter-app/ui/html/disclaimer.html} over HTTP, which only
 *       {@code DocxExporterAppServlet} can serve - from the app webapp and nowhere else.</li>
 * </ul>
...
class GeneratedHelpArticlesTest {
    ...
    private void assertArticleGenerated(String fileName) {
        String resource = "/webapp/docx-exporter-app/html/" + fileName;
