...
class DefaultSettingsStatusProviderTest {
    ...
    @Test
    void testGetStatus() {
        FileNameTemplateSettings coverPageSettings = mock(FileNameTemplateSettings.class);
        when(coverPageSettings.getFeatureName()).thenReturn(FileNameTemplateSettings.FEATURE_NAME);
