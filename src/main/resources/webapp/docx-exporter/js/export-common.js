...
const DocxExportCommon = {
    ...
    downloadTestRunAttachments: function (projectId, testRunId, revision = null, filter = null) {
        let url = `/polarion/docx-exporter/rest/internal/projects/${projectId}/testruns/${testRunId}/attachments?`;
    ...
    downloadAttachmentContent: function (projectId, testRunId, attachmentId, revision = null) {
        let url = `/polarion/docx-exporter/rest/internal/projects/${projectId}/testruns/${testRunId}/attachments/${attachmentId}/content?`;
        if (revision) url += `&revision=${revision}`;
    ...
    convertCollectionDocuments: function (exportParams, collectionId, onComplete, onError) {
        let url = `/polarion/docx-exporter/rest/internal/projects/${exportParams.projectId}/collections/${collectionId}/documents`;
        SbbCommon.callAsync({
            method: "GET",
            url: url,
            responseType: "json",
