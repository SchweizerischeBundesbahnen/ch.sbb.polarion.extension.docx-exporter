...
(function () {
    ...
    const EXT_BASE = (document.currentScript && document.currentScript.src || '').replace(/js\/dle-toolbar\.js.*$/, '') || '/polarion/docx-exporter/';
    ...
    engine.dataset.icon = `/polarion/ria/images/dle/operations/actionMsWordRoundtrip16.svg`;
