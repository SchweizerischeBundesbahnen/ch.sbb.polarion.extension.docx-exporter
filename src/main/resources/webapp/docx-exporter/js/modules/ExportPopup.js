...
export default class ExportPopup {
    ...
    initPopup() {
        ...
        // drop the cached instance and any previous element so a rebuilt popup re-binds correctly —
        // otherwise a 2nd+ open targets the detached old node and nothing appears.
