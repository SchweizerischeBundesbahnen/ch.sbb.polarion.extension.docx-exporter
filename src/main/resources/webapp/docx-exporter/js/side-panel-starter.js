const DocxExporterSidePanelStarter = {
    ...
    injectAll: function () {
        ...
        this.injectScript("export-docx-common-script", `/polarion/docx-exporter/ui/js/export-common.js${this.timestampParam}`);
        this.injectScript("export-docx-script", `/polarion/docx-exporter/ui/js/export-pdf.js${this.timestampParam}`);
    },
