<%@ page import="ch.sbb.polarion.extension.docx_exporter.util.RolesUtils" %>
...
<head>
    <title>DOCX Exporter: Authorization</title>
...
<div class="standard-admin-page">
    <h1>DOCX Exporter: Authorization</h1>
...
<div class="standard-admin-page">
    ...
    <div class="quick-help-text">
        <h3>Permissions</h3>
        <p>Here you can restrict who is allowed to export documents to DOCX, based on Polarion global or project roles.</p>
