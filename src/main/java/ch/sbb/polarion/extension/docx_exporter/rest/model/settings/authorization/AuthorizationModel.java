package ch.sbb.polarion.extension.docx_exporter.rest.model.settings.authorization;
...
/**
 * Roles allowed to export documents to DOCX. When both lists are empty the export is unrestricted
