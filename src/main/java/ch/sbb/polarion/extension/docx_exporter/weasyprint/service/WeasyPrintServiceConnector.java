package ch.sbb.polarion.extension.docx_exporter.weasyprint.service;

import ch.sbb.polarion.extension.docx_exporter.properties.DocxExporterExtensionConfiguration;
import ch.sbb.polarion.extension.docx_exporter.weasyprint.WeasyPrintConverter;
...
public class WeasyPrintServiceConnector implements WeasyPrintConverter {
    ...
    public WeasyPrintServiceConnector() {
        this(DocxExporterExtensionConfiguration.getInstance().getWeasyprintService());
    }
    ...
    public byte[] convertToPdf(String htmlPage, WeasyPrintOptions weasyPrintOptions) {
        ...
        try {
            ...
            String weasyprintPdfVariant = DocxExporterExtensionConfiguration.getInstance().getWeasyprintPdfVariant();
