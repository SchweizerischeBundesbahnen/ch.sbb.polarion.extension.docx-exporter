...
public class DleToolbarStatusProvider extends ConfigurationStatusProvider {
    ...
    public @NotNull ConfigurationStatus getStatus(@NotNull Context context) {
        ...
        return getConfigurationStatus(DLE_TOOLBAR, content, "scriptInjection.dleEditorHead=<script src=\"/polarion/docx-exporter/js/starter.js\"></script>.*<script>PdfExporterStarter.injectToolbar(.*);</script>");
    }
}
