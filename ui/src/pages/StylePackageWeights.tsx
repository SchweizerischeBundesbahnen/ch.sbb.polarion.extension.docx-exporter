...
/**
 * DOCX Exporter: Style Package Weights - the shared ordering page over this extension's own
...
export default function StylePackageWeightsPage() {
  ...
  return <StylePackageWeights title="DOCX Exporter: Style Package Weights" service={service} />;
}
