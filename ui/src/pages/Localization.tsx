...
/**
 * DOCX Exporter: Localization - the German, French and Italian translations of the work item statuses
 * and severities printed into the document, one named configuration at a time.
 *
...
export default function Localization() {
  ...
  return (
    <PageLayout title="DOCX Exporter: Localization">
