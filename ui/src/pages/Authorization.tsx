...
/**
 * DOCX Exporter: Authorization - the shared role-selection page over this extension's `authorization`
...
export default function Authorization() {
  ...
  return (
    <AuthorizationSettings
      title="DOCX Exporter: Authorization"
      service={service}
      quickHelp={
        <>
          <h3>Permissions</h3>
          <p>
            Here you can restrict who is allowed to export documents to DOCX, based on Polarion global or project roles.
          </p>
          <p>
