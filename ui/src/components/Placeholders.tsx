/**
 * The special variables the filename template understands. Fewer than the PDF exporter's: there are no
 * page counters in a DOCX filename.
 */
const PLACEHOLDERS: [string, React.ReactNode][] = [
  ...
  ['TIMESTAMP', 'Date and time of DOCX generation'],
];
