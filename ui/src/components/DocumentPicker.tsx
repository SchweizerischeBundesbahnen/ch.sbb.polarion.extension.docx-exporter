...
/**
 * Picks one of a project's real documents, for the development harness.
 *
 * The Document Properties side panel harness runs the **real** panel against a **real** document: the
 * page writes the Polarion editor hash that document is opened at, and the panel reads it exactly as it
 * does in Polarion. Choosing that document is this component.
 *
 * It needs a Polarion: `VITE_BASE_URL` for the proxy and `VITE_BEARER_TOKEN` for the platform API the
 * document list comes from. The project is the scope the Overview page carries, the same way every
 * feature page gets it.
 */

/** The last document picked, remembered across visits. Scoped by project, since ids are per project. */
const DOCUMENT_COOKIE = 'docx-exporter-dev-document';
