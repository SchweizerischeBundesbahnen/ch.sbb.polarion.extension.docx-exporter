...
//
// The article directory defaults to the shipped webapp html (src/main/resources/webapp/docx-exporter-app/html,
...
const indexDir = process.env.DOCS_SECTION_INDEX_DIR
  ...
  : resolve(repoRoot, 'src/main/resources/webapp/docx-exporter-app/html');
