...
describe('Disclaimer', () => {
  it('renders the build-generated article', async () => {
    ...
    expect(String(fetchMock.mock.calls[0][0])).toBe('/polarion/docx-exporter/rest/internal/disclaimer');
  });
  ...
  it('points at the online source when the extension ships no disclaimer', async () => {
    ...
    expect(link?.href).toBe(
      'https://github.com/SchweizerischeBundesbahnen/ch.sbb.polarion.extension.docx-exporter/blob/main/DISCLAIMER.md',
    );
  });
