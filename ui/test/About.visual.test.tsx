    ...
    installFetchMock([
      {
        ...
        match: /\/version$/,
        json: {
          bundleName: 'DOCX Exporter',
          bundleVendor: 'SBB',
          supportEmail: 'polarion-opensource@sbb.ch',
          automaticModuleName: 'ch.sbb.polarion.extension.docx_exporter',
          bundleVersion: '1.0.0',
      ...
      },
      {
        ...
        json: {
          properties: [
            {
              key: 'ch.sbb.polarion.extension.docx-exporter.some.property',
              value: 'value',
              defaultValue: 'value',
      ...
      },
      {
        ...
        json: [{ name: 'DOCX Exporter', status: 'OK', details: 'ready' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response(
            '<h1>DOCX Exporter Extension for Polarion ALM</h1><p>Exports Polarion documents and work items to DOCX.</p>',
            { status: 200 },
          ),
      },
    ]);
