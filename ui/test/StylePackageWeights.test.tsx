...
describe('Style Package Weights page', () => {
  it('lists the packages of the scope, heaviest first', async () => {
    ...
    expect(document.body.textContent).toContain('DOCX Exporter: Style Package Weights');
  ...
  it('posts the reordered weights to this extension’s endpoint', async () => {
    ...
    await vi.waitFor(() => {
      ...
      expect(String(post![0])).toContain('/polarion/docx-exporter/rest/internal/settings/style-package/weights');
